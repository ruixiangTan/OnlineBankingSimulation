...
public class RandomCreditCardNumberGenerator {
    ...
    public static String generateVisaCardNumber() {
        String visaNumber = credit_card_number(VISA_PREFIX_LIST, 16, 1)[0];
        while (!isValidCreditCardNumber(visaNumber))
            visaNumber = credit_card_number(VISA_PREFIX_LIST, 16, 1)[0];
        return visaNumber;
    }
